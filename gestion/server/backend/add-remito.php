...
try {
    ...
    */
    ...
    $stmt = $base_de_datos->prepare("
        INSERT INTO remito (nroFactura,fechaPagado,fechaVencimiento,empresa, empresa_destino, valor_total, email, archivos, estado, fechaFacturado, fechaEnvio, descripcion, nroRemito, debe,fecha,dominio,detalle,facturas,incluirArchivos,incluirFacturas,fechaRemito)
        VALUES (:nroFactura ,:fechaPagado, :fechaVencimiento,:empresa,:empresa_destino, :valor_total, :email, :archivos, :estado, :fechaFacturado, :fechaEnvio ,:descripcion, :nroRemito, :debe,:fecha,:dominio,:detalle,:facturas,:incluirArchivos,:incluirFacturas,:fechaRemito)
    ");
